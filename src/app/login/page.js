      ...
      <div className="login-card glass-card" role="main" style={{ maxWidth: 480 }}>
        ...
        <div className="login-header">
          ...
          <p className="login-subtitle">
            {mode === 'reset' ? t('auth.resetPasswordInstructions') : t('auth.signInToContinue')}
          </p>
        </div>
        ...
        <div style={{ textAlign: 'center', marginTop: 'var(--sp-lg)', fontSize: 'var(--fs-sm)', color: 'var(--clr-text-muted)' }}>
          {mode === 'login' && (
            <p>
              ...
              <button type="button" id="switch-to-signup" onClick={() => router.push('/register')} style={{ color: 'var(--clr-primary)', fontWeight: 600, background: 'none', border: 'none', cursor: 'pointer', padding: 0, fontSize: 'inherit' }}>
